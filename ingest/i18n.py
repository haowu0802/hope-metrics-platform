...
MESSAGES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "title": "Hope Metrics",
        "brand": "Hope Metrics",
        "lede": "Ingest status for donated-device active minutes. Charts live in Metabase; dbt and Feishu run on GitHub Actions.",
        ...
        "tools_unset": "Set METABASE_URL on the app to show a Metabase link.",
        "foot_api": "API",
    },
    "zh": {
        "html_lang": "zh-Hans",
        "title": "Hope Metrics",
        "brand": "Hope Metrics",
        "lede": "捐赠设备活跃分钟的接入状态。图表在 Metabase；dbt 与飞书告警在 GitHub Actions。",
        "status_kicker": "接入实况",
        ...
        "tools_unset": "在应用上设置 METABASE_URL 以显示看板链接。",
        "foot_api": "接口",
    },
}
